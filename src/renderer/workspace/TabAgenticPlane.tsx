        ...
        <PlaneChatDock
          ...
          chat={quickChatMounted && openChatAgentId ? (
            <PlaneQuickChat
              ...
              activityKey={quickChatStatus?.activityKey ?? ''}
              activityStartedAtMs={quickChatStatus?.activityStartedAtMs ?? 0}
              lastEventAtMs={quickChatStatus?.lastEventAtMs ?? 0}
              canGoStale={quickChatStatus?.activityCanGoStale ?? false}
              awaitingDelegations={Boolean(quickChatStatus?.awaitingDelegations)}
              orchestrationAwaiting={quickChatOrchestrationAwaiting}
