...
describe('OnboardingCoachMark scopeRef', () => {
  it('ignora el ancla de una tab inactiva y mide la del plano activo', () => {
    ...
    // El aro va en el ancla del plano activo, no en la copia de la tab inactiva.
    expect(activeAnchor.classList.contains('onboarding-coach-target')).toBe(true)
    expect(inactiveAnchor.classList.contains('onboarding-coach-target')).toBe(false)
  })
