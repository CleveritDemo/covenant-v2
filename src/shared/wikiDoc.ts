...
export function buildWikiWritingGuidance(): string {
  return [
    ...
    'Write short and plain: facts, paths, [[links]]. No poetry, no narration, no padding.',
    'Prefer simple over deep. One rule or locate per page.',
    ...
    'The wiki is an index for agents (humans are secondary): many short nodes, dense with [[slug]] links and real file paths. Scarcity of nodes is a failure; long prose is also a failure.',
    'Each page does ONE job:',
    '- narrate (concept): why it exists in 1–2 sentences — product intent, local vs org. Not a story.',
    ...
    '- concept/narrate: "Human says what/why; agents do how. Local = one folder; org = ready environment. See [[agentic-plane]] [[workspace-logic]]."',
    ...
    'Bad (do not write): essays, poetry, narration, or a feature checklist dumped into one page. Missing [[links]] or file paths.',
