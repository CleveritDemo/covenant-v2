...
const bladeRunnerLight: AppTheme = {
  ...
  vars: {
    ...
    '--accent-dim': '#854703',
    '--danger': '#d93b5c',
    '--tab-active-bg': '#f6f2ec',
    '--tab-inactive-bg': '#fdfcf9',
    '--scrollbar': '#e0d4c4',
    '--radius': '8px',
  },
  xterm: {
