...
/** Zelda — Breath of the Wild: noche de Hyrule — korok, Sheikah, Zora, silent princess, blood moon */
const zeldaDeepWoods: AppTheme = {
  ...
  vars: {
    ...
    '--bg-secondary': '#0a1008',
    '--surface': '#121a0e',
    '--surface-hover': '#1c2814',
    /* Bronce Sheikah: el chrome no hereda solo del acento verde. */
    '--border': '#4a4230',
    '--text': '#efe8d4',
    '--text-muted': '#8a9470',
    /* Hoja korok (no cian neón). */
    '--accent': '#62d96e',
    '--accent-dim': '#2e9a48',
    '--danger': '#e04545',
    '--tab-active-bg': '#162014',
    '--tab-inactive-bg': '#040603',
    '--scrollbar': '#5a5038',
    '--radius': '10px',
  },
  xterm: {
