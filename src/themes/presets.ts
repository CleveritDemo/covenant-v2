...
const vikings: AppTheme = {
  ...
  vars: {
    ...
    '--accent-dim': '#a07a12',
    '--danger': '#c44a3c',
    '--tab-active-bg': '#151e2a',
    '--tab-inactive-bg': '#0a1018',
    '--scrollbar': '#2a3a4c',
    '--radius': '8px',
  },
  xterm: {
...
const ragnarokOnline: AppTheme = {
  ...
  vars: {
    ...
    '--accent-dim': '#3a98c0',
    '--danger': '#e06070',
    '--tab-active-bg': '#1a1c34',
    '--tab-inactive-bg': '#0c0e1a',
    '--scrollbar': '#3a3c68',
    '--radius': '10px',
  },
  xterm: {
...
const metroid: AppTheme = {
  ...
  vars: {
    ...
    '--accent-dim': '#b06820',
    '--danger': '#d05040',
    '--tab-active-bg': '#101a14',
    '--tab-inactive-bg': '#050a08',
    '--scrollbar': '#2a4034',
    '--radius': '8px',
  },
  xterm: {
...
const pokemon: AppTheme = {
  ...
  vars: {
    ...
    '--accent-dim': '#2a5a98',
    '--danger': '#c85048',
    '--tab-active-bg': '#1c2638',
    '--tab-inactive-bg': '#0e1420',
    '--scrollbar': '#3a4a64',
    '--radius': '10px',
  },
  xterm: {
...
const dragonBallZ: AppTheme = {
  ...
  vars: {
    ...
    '--accent-dim': '#b05818',
    '--danger': '#d04050',
    '--tab-active-bg': '#1e1828',
    '--tab-inactive-bg': '#0c0a12',
    '--scrollbar': '#4a3858',
    '--radius': '8px',
  },
  xterm: {
...
const saintSeiya: AppTheme = {
  ...
  vars: {
    ...
    '--accent-dim': '#988020',
    '--danger': '#c84858',
    '--tab-active-bg': '#161e34',
    '--tab-inactive-bg': '#080c18',
    '--scrollbar': '#344068',
    '--radius': '10px',
  },
  xterm: {
